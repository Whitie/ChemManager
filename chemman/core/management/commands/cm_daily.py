        ...
        for chem in Chemical.objects.select_related().all():
            ...
            if chem.identifiers.pubchem_id and not chem.structure:
                ...
                if data:
                    ...
                    chem.structure.save(
                        "{id}_structure.png".format(id=chem.pk), fp, save=True
                    )
