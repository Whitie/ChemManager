...
class OperatingInstructionDraft(models.Model):
    ...
    extra_info = models.CharField(_("Extra Info"), max_length=100, blank=True)
    work_departments = models.ManyToManyField(
        WorkDepartment,
        verbose_name=_("Work Departments"),
        related_name="operating_instruction_drafts",
    )
    ...
    conduct = models.TextField(_("Conduct in case of danger"), default="-")
    conduct_pics = models.ManyToManyField(
        ProtectionPictogram,
        verbose_name=_("Conduct Pictograms"),
        blank=True,
        related_name="drafts",
    )
    ...
    skin = models.CharField(
        _("After skin contact"), max_length=150, default="-"
    )
    eye = models.CharField(_("After eye contact"), max_length=150, default="-")
    breathe = models.CharField(
        _("After breathe in"), max_length=150, default="-"
    )
    ...
    released = models.DateField(
        _("Released"), blank=True, editable=False, default=None, null=True
    )
    saved_as = models.ForeignKey(
        OperatingInstruction,
        verbose_name=_("Saved as"),
        blank=True,
        null=True,
        default=None,
